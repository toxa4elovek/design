    ...
    _createClass(PhoneNumberInput, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                'div',
                null,
                React.createElement('input', { style: styles, ref: 'input', type: 'text', onChange: this.onChange.bind(this), onFocus: this.onFocus.bind(this), onBlur: this.onBlur.bind(this), defaultValue: initialValue, className: 'phone-number-input' })
            );
        }
    }]);
