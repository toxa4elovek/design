...
var UserAutosuggestPerson = (function (_React$Component2) {
    ...
    _createClass(UserAutosuggestPerson, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                'li',
                { 'data-selected': this.selected, style: liStyle, onClick: this.onClick.bind(this).bind(object), onMouseEnter: this.onMouseOver.bind(this), onMouseLeave: this.onMouseOut.bind(this) },
                React.createElement(
                    'a',
