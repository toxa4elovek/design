(function($){
    ...
    $.fn.tooltip2 = function(instanceSettings){
        ...
        $.fn.tooltip2.defaultsSettings = {
            ...
            tooltipSourceURL:'',
            tooltipID:'tooltip',
            tooltipPosBottom:'tooltip-pos-bottom'
        };
        ...
        var positionTooltip = function(e){
            ...
            var p = {
                x: posx + s.positionLeft - s.correctPosX,
                y: posy + s.positionTop,
                y: posy - $('#'+s.tooltipID).height() - 20,
                w: $('#'+s.tooltipID).width(),
            ...
            if(p.y + p.h > v.y + v.h && p.x + p.w > v.x + v.w){
             ...
             p.x = p.x;
             p.y = p.y - (((p.y+p.h)-(v.y+v.h)) + 10);
             $('#'+s.tooltipID).addClass(s.tooltipPosBottom);
             }
