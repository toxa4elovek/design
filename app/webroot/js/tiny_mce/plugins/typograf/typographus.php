...
class typographus
{
     ...
     */
    public function typographus($encoding = null)
    {
    ...
    public function process($str)
    {
        ...
        $pattern .= '<[^>]*[\s][^>]*>)';
        $str = preg_replace_callback("~$pattern~isU", [&$this, '_stack'], $str);
     ...
     * @return array
     */
    public function _stack($matches = false)
    {
        if ($matches !== false) {
     ...
     * @return String
     */
    public function apply_rules($rules, $str)
    {
