...
jQuery.migrateMute === void 0 && (jQuery.migrateMute = !0), (function (e, t, n) {
  "use strict";function r(n) {
    ...
    a = a || document, a = !a.nodeType && a[0] || a, a = a.ownerDocument || a, r("jQuery.clean() is deprecated");var s,
        ...
        c,
        l,
        d = [];if ((e.merge(d, e.buildFragment(t, a).childNodes), o)) for (c = function (e) {
      return !e.type || j.test(e.type) ? i ? i.push(e.parentNode ? e.parentNode.removeChild(e) : e) : o.appendChild(e) : n;
    }, s = 0; null != (u = d[s]); s++) e.nodeName(u, "script") && c(u) || (o.appendChild(u), u.getElementsByTagName !== n && (l = e.grep(e.merge([], u.getElementsByTagName("script")), c), d.splice.apply(d, [s + 1, 0].concat(l)), s += l.length));return d;
  });var Q = e.event.add,
      x = e.event.remove,
      k = e.event.trigger,
      N = e.fn.toggle,
    ...
    };for (s.guid = o; a.length > i;) a[i++].guid = o;return this.click(s);
