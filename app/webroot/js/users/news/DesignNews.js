...
var DesignNews = function (_React$Component) {
    _inherits(DesignNews, _React$Component);

    function DesignNews() {
        _classCallCheck(this, DesignNews);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(DesignNews).apply(this, arguments));
    }

    _createClass(DesignNews, [{
        key: 'render',
