...
;(function (factory) {
	...
	var d = [],
	    doc = $(document),
	    ie6 = $.browser.msie && parseInt($.browser.version) === 6 && _typeof(window['XMLHttpRequest']) !== 'object',
  ...
  */
   ...
   */
		create: function create(data) {
			...
			s.d.overlay = $('<div></div>').attr('id', s.o.overlayId).addClass('simplemodal-overlay').css($.extend(s.o.overlayCss, {
				...
				top: 0,
				zIndex: s.o.zIndex + 1
			})).after(s.o.close && s.o.closeHTML ? $(s.o.closeHTML).addClass(s.o.closeClass) : '').appendTo(s.o.appendTo);

			// create the container
			s.d.container = $('<div></div>').attr('id', s.o.containerId).addClass('simplemodal-container').css($.extend({ position: s.o.fixed ? 'fixed' : 'absolute' }, s.o.containerCss, { display: 'none', zIndex: s.o.zIndex + 2 }))
			/*.after(s.o.close && s.o.closeHTML
   ...
   */
		...
		getDimensions: function getDimensions() {
			...
			var s = this,
			    h = $.browser.opera && $.browser.version > '9.5' && $.fn.jquery < '1.3' || $.browser.opera && $.browser.version < '9.5' && $.fn.jquery > '1.2.6' ? wndw[0].innerHeight : wndw.height();
