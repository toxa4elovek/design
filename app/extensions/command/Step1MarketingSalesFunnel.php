...
class Step1MarketingSalesFunnel extends CronJob
{
    ...
    public function run()
    {
        ...
        array_walk($arrayOfProjects, function ($project) {
            ...
            $message = sprintf('%s, мы зачислили на лицевой счет %d рублей, которые вы сможете потратить на гонорары дизайнерам, если до %s оплатите годовое обслуживание и станете абонентом https://godesigner.ru/pages/subscribe',
