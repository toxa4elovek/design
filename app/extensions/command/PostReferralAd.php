...
class PostReferralAd extends CronJob
{
    ...
    public function run()
    {
        ...
        foreach ($projects as $project) {
            $message = 'Вы получите 500 рублей на&nbsp;телефон, когда ваши друзья создадут проект на&nbsp;GoDesigner. Узнать подробности и&nbsp;получить ссылку тут: https://godesigner.ru/pages/referal';
            $data = [
                'pitch_id' => $project->id,
                'user_id' => 108,
                'text' => $message,
