...
class UserAutosuggestPerson extends React.Component {
    ...
    render() {
        ...
        return <li data-selected={this.selected} style={liStyle} onClick={this.onClick.bind(this).bind(object)} onMouseEnter={this.onMouseOver.bind(this)} onMouseLeave={this.onMouseOut.bind(this)}>
            <a href="#" style={linkStyle} >
                <img alt={object.name} src={object.avatar} style={imgStyle}/>
                <span style={spanStyle}>{object.name}</span>
            </a>
        </li>;
    }
}