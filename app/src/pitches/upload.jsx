$(document).ready(function () {
  ...
  $('#uploadSolution').click(function () {
    ...
    $('#agree').on('click', function () {
      ...
      $('input[name=rights_tos]').prop('checked', 'checked')
      $('#uploadSolution').click()
      return false
    })

    if ((($('input[name=rights_tos]').attr('checked') !== 'checked') || ($('input[name=tos]').attr('checked') !== 'checked')) && ($('#filename').html() !== 'Файл не выбран')) {
