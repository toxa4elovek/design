...
class User extends \app\models\AppModel {
    ...
    public static function sendClientSpamNewPitch($params) {
        ...
        if ($params['pitch']->brief == 0) {
            $text = 'Ваша оплата прошла успешно и проект опубликован на сайте. Как только дизайнеры загрузят загрузят свои решения, комментируйте их, выставляйте рейтинг и помогайте лучше понять вас, и тогда вы точно получите то, что хотели.';
        } else {
