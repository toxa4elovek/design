...
class DebugTest extends AppUnit
{
    ...
    public function testDetectSpeedOfQuery()
    {
        ...
        $this->assertNull($this->debug->detectSpeedOfQuery([]));
    ...
    public function testGetVisualStyle()
    {
        ...
        $this->assertNull($this->debug->getVisualStyle([]));
    ...
    public function testGetHtmlForQuery()
    {
        ...
        $this->assertNull($this->debug->getHtmlForQuery([]));
    ...
    public function testGetQueryArray()
    {
        ...
        $this->assertNull($this->debug->getQueryArray([]));
        $expected = [
            'type' => 'sql',
            'timestamp' => 150,
            'elapsed_time' => 0.5,
    ...
    public function testIsDebugQuery()
    {
        ...
        $this->assertFalse($this->debug->isDebugQuery([]));
        $this->assertFalse($this->debug->isDebugQuery(['timestamp' => 1]));
        $this->assertFalse($this->debug->isDebugQuery(['timestamp' => 1, 'query' => '12']));
        $this->assertFalse($this->debug->isDebugQuery(['timestamp' => 1, 'query' => '12', 'elapsed_time' => 0.2]));
        $this->assertTrue($this->debug->isDebugQuery(['timestamp' => 1, 'query' => '12', 'elapsed_time' => 0.2, 'type' => 'redis']));
    }
