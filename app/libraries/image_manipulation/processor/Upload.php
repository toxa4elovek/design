 ...
 * @subpackage external
 */
namespace image_manipulation\processor;
...
class Upload {
     ...
     */
    function uploadandinit($file, $lang = 'en_GB') {
    ...
    function process($server_path = null) {
        ...
        if ($this->processed) {
            ...
            if(($image_manipulation == true) && ($this->image_x == 800) && ($this->image_src_x == $this->image_x) && ($this->image_src_y == 600)) {
                $image_manipulation = false;
            }
