...
$this->sans_fonts = ['dejavusanscondensed','dejavusans','freesans','liberationsans','sans','sans-serif','cursive','fantasy',
...
$this->serif_fonts = ['dejavuserifcondensed','dejavuserif','freeserif','liberationserif','serif',
...
$this->mono_fonts = ['dejavusansmono','freemono','liberationmono','courier', 'mono','monospace','ocrb','ocr-b','lucidaconsole',
