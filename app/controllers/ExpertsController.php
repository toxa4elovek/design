...
class ExpertsController extends AppController
{
     ...
     * @var array
     */
    public $publicActions = ['index', 'view', 'viewByUser'];
    ...
    {
        $experts = Expert::all(['order' => ['id' => 'asc'], 'conditions' => ['enabled' => 1]]);
    ...
    {
        if ($expert = Expert::first(['conditions' => ['user_id' => $this->request->id]])) {
