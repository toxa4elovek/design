                    ...
                    <table>
                                ...
                                <div id="s3_kv">
                                    ...
                                    <div class="pay-yur">
                                        ...
                                        <form action="/bills/save" method="post" id="bill-yur">
                                            ...
                                            <p>Мы свяжемся с вами в течение рабочего дня после поступления денег и договоримся об удобном времени для заполнения брифа.</p>
                        ...
                        <!--tr class="paymaster-section">
                            ...
                            <td colspan="1" class="s3_text" style="padding-left: 20px;">
                                Оплата пластиковыми картами и эл. деньгами через PayMaster<br><br>
                            </td>
                        </tr>
