<projects type="array">
    ...
    <project>
        ...
        <short-description><?php if($pitch->private == 0):?><?php echo nl2br($pitch->description) ?><?php else:?>Это закрытый питч и вам нужно подписать соглашение о неразглашении!<?php endif?></short-description>
