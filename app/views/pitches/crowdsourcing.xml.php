<projects type="array">
    ...
    <project>
        ...
        <short-description><?php if($pitch->private == 0):?><?php echo $this->Brief->trim_all(htmlspecialchars(nl2br($pitch->description)), "\x0B", '');?><?php else:?>Это закрытый проект и вам нужно подписать соглашение о неразглашении!<?php endif?></short-description>
