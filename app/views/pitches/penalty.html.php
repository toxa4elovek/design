                    ...
                    <div class="photo_opt" style="padding-top:0; margin-top:144px;">
                        ...
                        <ul style="margin-left: 78px;" class="right">
                            <li class="like-hoverbox" style="float: left; margin-top: 0; padding-top: 0; height: 15px; padding-right: 0; margin-right: 0; width: 38px;">
                                ...
                                <span class="underlying-likes" style="color: rgb(205, 204, 204); font-size: 10px; vertical-align: middle; display: block; float: left; height: 16px; padding-top: 1px; margin-left: 2px;" data-id="<?= $solution->id ?>" rel="https://godesigner.ru/pitches/viewsolution/<?= $solution->id ?>"><?= $solution->likes ?></span>
                            </li>
                        </ul>
                    </div>
