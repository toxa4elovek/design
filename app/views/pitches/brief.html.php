		...
		<div class="main">
            ...
            text-transform: uppercase;margin-bottom:20px;">Дополнительные опции</h1>
                    ...
                    <div class="ribbon complete-brief">
                        <p class="option"><label><input type="checkbox"  disabled="disabled" name="" <?php if($this->Session->read('fillbrief')): echo 'checked="checked"'; endif;?> class="single-check" data-option-title="Заполнение брифа" data-option-value="750" id="phonebrief">Заполнить бриф</label></p>
                        ...
                        <p><input disabled="disabled" type="text" id="phonenumber" name="phone-brief" placeholder="+7 XXX XXX XX XX" class="phone" value=""></p>
