...
?>
        <div class="groupc">
            <p>
                ...
                <textarea <?php if(!$this->brief->isUsingPlainText($pitch)) { echo 'class="enable-editor"';}?> id="full-description" name="description" cols="40" rows="10" required placeholder="<?= $word2 ?>" data-placeholder="<?= $word2 ?>" data-low="70" data-normal="140" data-high="380" ><?=$pitch->description?></textarea>
            </p>
