    ...
    <div class="main">
        ...
        <?php if($pitch->guaranteed == '0'): ?>
            <div class="ribbon" id="guaranteed-block">
                <p class="option"><label><input type="checkbox" id="guaranteed" name="" <?php if(isset($this->_request->query['click']) && $this->_request->query['click'] == 'guarantee'): echo 'checked'; endif?> class="single-check" data-option-title="Гарантировать проект" data-option-value="950">Гарантировать проект</label></p>
                ...
                <p class="label <?php if(isset($this->_request->query['click']) && $this->_request->query['click'] == 'guarantee'): echo 'unfold'; endif?>">+950.-</p>
            </div>
        <?php endif ?>
        ...
        <?php if(($pitch->private == '0') && ($pitch->id == '105318')): ?>
            <div class="ribbon" id="private-block">
                ...
                <p class="description">Проект станет не виден для поисковых систем, а идеи будут доступны для просмотра только вам и их авторам. Подробнее <a target="_blank" href="https://www.godesigner.ru/answers/view/64">тут</a></p>
