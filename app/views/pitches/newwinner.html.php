<div class="wrapper">
    ...
    <?= $this->html->script(array('jquery-ui-1.11.4.min.js', 'jquery.scrollto.min.js', 'pitches/newwinner.js?' . mt_rand(100, 999), 'jquery.numeric', 'jquery.iframe-transport.js', 'jquery.fileupload.js', 'jquery.simplemodal-1.4.2.js', 'jquery.tooltip.js', 'popup.js', 'jquery.damnUploader.js'), array('inline' => false)) ?>
    <?=
