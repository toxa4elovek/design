...
<?=$this->html->script(array('jquery.hover.js', 'experts/view'), array('inline' => false))?>
<?=$this->html->style(array('/text', '/howitworks', '/expert-personal', '/messages12.css'), array('inline' => false))?>