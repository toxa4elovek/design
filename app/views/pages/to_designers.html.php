                    ...
                    <div class="w100">
                        <ul class="marsh">
                            ...
                            <li>
                                ...
                                <p class="regular">Не расстраивайтесь, если вы не выиграли в этот раз: вы можете попытать счастье в другом проекте с тем же решением: до момента приобретения идеи заказчиком, все решения являются собственностью автора.</p>
                            </li>
