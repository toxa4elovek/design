				...
				<div class="w100">
					<ul class="marsh" id="advantages">
						<li style="margin-bottom: 70px;">
							...
							<p class="regular">Вы сами решаете, сколько<br/> платить дизайнеру. Сервисный сбор GoDesigner составит 30,5&#8209;39,5% установленной суммы вознаграждения победителю.
							</p>
						</li>
						<li style="margin-bottom: 70px;">
