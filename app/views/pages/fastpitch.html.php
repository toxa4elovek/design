                ...
                <div id="ap_content_top">
                    <div id="ap_content_top_l">
                        ...
                        <div class="fastpitch-step3">
                            <h2 class="fastpitch-secondary-header">Оплатите 21 400 рублей,<br> остальное мы сделаем за вас!</h2>
                            ...
                            <a class="fastpitch button third" style="margin-top: 30px;color:#fff;cursor:pointer;">Оплатить 21 400 р.  и запустить проект</a>
                            <table>
                                ...
                                <tr height="22"><td>сбор сервиса</td><td>39,5%</td></tr>
                                <tr height="22"><td>скидка</td><td><span class="table-left-price">-4330</span></td></tr>
                        ...
                        <div class="fastpitch-bottom">
                            <h1 class="fastpitch-main-header second-part" style="margin-left: 0; margin-top: 20px; margin-bottom: 35px;">Что включено в 21400 р.-</h1>
                            <p style="width: 640px; color: #666;">С нашим предложением вы экономите не только 2 часа на заполнение брифа,<br/>но и деньги.  Стоимость кейса «Логотип в один клик» — 21400 рублей, что на 4330  дешевле, как если бы вы создавали аналогичный проект обычным способом. </p>
