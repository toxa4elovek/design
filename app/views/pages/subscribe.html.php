<div class="wrapper">
    ...
    <main class="lp-subscribe">
        ...
        <section class="lp-headline">
            ...
            Решайте творческие и технические задачи через сервис,<br /> и выбирайте лучшии идеи!
        </section>
        <section class="lp-explain paper-background">
            ...
            <ul>
                ...
                <li class="last">Для бухгалтерии<br/>
                    предоставим все закрывающие<br/> документы автоматически</li>
            </ul>
            </div>
        </section>
        ...
        <section class="lp-table paper-background">
            ...
            <table class="tariff-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="title-cell" colspan="2">Все идеи можно доступны в 100% разрешении</td>
                        <td class="tick-cell"><img src="/img/pages/subscribe/tick.png" alt="Включено"></td>
                        <td class="tick-cell"><img src="/img/pages/subscribe/tick.png" alt="Включено"></td>
                    </tr>
                    <tr>
