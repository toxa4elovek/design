    ...
    <div class="middle" id="login-section" style="display:none;">
        ...
        <div class="main">
            ...
            <section>
                ...
                <p><?= $this->html->link('Создать аккаунт', 'Users::registration', ['class' => 'button second', 'id' => 'reg-button']) ?></p>
            </section>

        </div><!-- .main -->
    </div><!-- .middle -->

    <?= $this->view()->render(['element' => 'popups/register'], ['freePitch' => $freePitch]); ?>
...
<?= $this->html->script(['users/registration.js', 'users/activation.js'], ['inline' => false]) ?>
