                ...
                <section class="referal-section">
                    ...
                    <section class="referal-block block-3" style="display: none;">
                        <form id="referal-3" action="" method="post" style="margin: 35px 0 30px 0;">
                            ...
                            <input type="text" name="" value="https://godesigner.ru/?ref=<?=$user->referal_token;?>" style="width: 270px; float: left; margin-top: 3px; font-size: 15px; font-weight: bold; color: #999;">
                        ...
                        ?>
                        <a href="http://www.facebook.com/sharer/sharer.php?s=100&p[url]=https://godesigner.ru/?ref=<?=$user->referal_token?>&p[title]=<?php echo urlencode($shareTitleFacebook);?>&p[summary]=<?php echo urlencode($shareTextFacebook);?>" class="button facebook small social-popup" style="width: 176px;">Поделиться в facebook</a>
                        <a href="http://www.vkontakte.ru/share.php?url=https://godesigner.ru/?ref=<?=$user->referal_token?>&title=<?php echo urlencode($shareTitleFacebook);?>&description=<?php echo urlencode($shareTextFacebook);?>&noparse=1" class="button vkontakte small social-popup" style="width: 176px;">Поделиться vkontakte</a>
                        <a href="https://twitter.com/share?url=http://godesigners.ru/?ref=<?=$user->referal_token?>&text=<?php echo urlencode($shareTextTwitter);?>" class="button twitter small social-popup" style="width: 176px;">Поделиться в twitter</a>
...
<?=$this->html->script([    '/js/users/office/PushNotificationsStatus.js', 'jcarousellite_1.0.1.js', 'jquery.timers.js', 'jquery.simplemodal-1.4.2.js', 'tableloader.js', 'jquery.timeago.js', 'fileuploader', 'jquery.tooltip.js', 'users/office.js'], ['inline' => false])?>
