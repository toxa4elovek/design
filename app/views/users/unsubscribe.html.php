        ...
        <div class="main" style="width: 381px; height:240px">
            ...
            <section style="padding-top: 40px;padding-left:40px;padding-right:40px;">
                <p style="color: #6a6a6a;margin-bottom:24px">
                    Вы уверены, что больше не хотите получать от нас рассылку о новостях, новых питчах, комментариях? Нажимая «Да, отписаться» мы больше не побеспокоим вас своими письмами.
                </p>
