                ...
                <section>
                    ...
                    <div class="message_inf2" style="margin-bottom: 10px;">
                        <div class="message_text2">
                            <span class="regular comment-container"><?php echo $this->brief->eee($comment->originalText); ?></span>
                        </div>
                    </div>
                    ...
                    if(!empty($comment->images)):
                        if(isset($comment->images['file'][0])) :
                            foreach($comment->images['file'] as $file):?>
                                <div class="file_link">
                                    <a class="file-link-attach" href="/files/<?=$file['basename']?>"><?=$file['basename']?></a>
                                    <!--a href="" class="marker"><img src="/img/marker10.png" /></a-->
                                </div>
                                <?php endforeach;
                        else :?>
                            <div class="file_link">
                                <a class="file-link-attach" href="/files/<?=$comment->images['file']['basename']?>"><?=$comment->images['file']['basename']?></a>
                                <!--a href="" class="marker"><img src="/img/marker10.png" /></a-->
                            </div>
                            <?php endif;
