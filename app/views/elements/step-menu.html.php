<ul>
    ...
    <li><?=$this->html->link('<span>Пригласи друга</span>', 'https://www.godesigner.ru/users/referal', array('escape' => false, 'class' => (in_array($this->_request->action, ['referal', 'subscribers_referal'])) ? 'active' : '')) ?></li>
</ul>