<table style="width: 200px;margin-bottom: 30px;">
    ...
    <tr height="25"><td><a class="blogtaglink" href="/posts?tag=<?=urlencode('cовет в обед')?>">cовет в обед</a></td><td><a class="blogtaglink" href="/posts?tag=<?=urlencode('интервью')?>">интервью</a></td></tr>
    ...
    <tr height="25"><td><a class="blogtaglink" href="/posts?tag=<?=urlencode('логотипы')?>">логотипы</a></td><td><a class="blogtaglink" href="/posts?tag=<?=urlencode('топ 10')?>">топ 10</a></td></tr>
