...
<table style="padding-bottom: 0; margin-bottom: 50px;">
    <tr>
        <?php if((int) $category->id === 22):?>
            <td style="width: 105px; font-size: 18px; font-family: OfficinaSansC Book, serif; color: #666666"><span style="position: relative; left: -8px; top: -3px;"><?= $category->shortestTimelimit ?> день</span></td>
            <td style="width: 91px; font-size: 18px; font-family: OfficinaSansC Book, serif; color: #666666"><span style="position: relative; left: 20px; top: -3px;"><?= $category->shortTimelimit ?> дня</span></td>
            <td style="width: 141px; font-size: 18px; font-family: OfficinaSansC Book, serif; color: #666666"><span style="position: relative; left: 47px; top: -3px;"><?= $category->default_timelimit ?> дня</span></td>
            <td style="width: 105px; font-size: 18px; font-family: OfficinaSansC Book, serif; color: #666666"><span style="position: relative; left: 33px; top: -3px;"><?= $category->smallIncreseTimelimit ?> дня</span></td>
    ...
    <tr>
        <?php if((int) $category->id === 22):?>
            <td><input style="position: relative; left: 8px;" type="radio" class="short-time-limit" name="short-time-limit" data-option-period="2" <?php if (($pitch) && ($pitch->timelimit == 2)): echo 'checked'; endif;?> data-option-title="Установлен срок" data-option-value="1000" ></td>
            <td><input style="position: relative; left: 40px;" type="radio" class="short-time-limit" name="short-time-limit" data-option-period="1" <?php if (($pitch) && ($pitch->timelimit == 1)): echo 'checked'; endif;?> data-option-title="Установлен срок" data-option-value="500" ></td>
            ...
            <td><input style="position: relative; left: 58px;" type="radio" class="short-time-limit" name="short-time-limit" data-option-period="3" <?php if (($pitch) && ($pitch->timelimit == 3)): echo 'checked'; endif;?> data-option-title="Установлен срок" data-option-value="500" ></td>
            <td><input style="position: relative; left: 81px;" type="radio" class="short-time-limit" name="short-time-limit" data-option-period="4" <?php if (($pitch) && ($pitch->timelimit == 4)): echo 'checked'; endif;?> data-option-title="Установлен срок" data-option-value="1000" ></td>
        <?php else:?>
    ...
    <tr>
        <?php if((int) $category->id === 22):?>
            <td style="font-size: 18px; font-family: OfficinaSansC Book, serif; color: #666666"><span style="position: relative; left: -12px;">+1000р.</span></td>
            <td style="font-size: 18px; font-family: OfficinaSansC Book, serif; color: #666666"><span style="position: relative; left: 23px;">+500р.</span></td>
            ...
            <td style="font-size: 18px; font-family: OfficinaSansC Book, serif; color: #666666"><span style="position: relative; left: 42px;">+500р.</span></td>
            <td style="font-size: 18px; font-family: OfficinaSansC Book, serif; color: #666666"><span style="position: relative; left: 62px;">+1000р.</span></td>
        <?php else:?>
