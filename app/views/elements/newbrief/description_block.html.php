<div class="groupc" style="background: none;position:relative;">
    <p style="">
        ...
        <textarea <?php if((!$pitch) ||(($pitch) && (!$this->brief->isUsingPlainText($pitch)))) { echo 'class="enable-editor"';}?> id="full-description" name="description" cols="40" rows="10" data-placeholder="<?= $word2 ?>" data-low="70" data-normal="340" data-high="680" ><?php if($pitch):?><?=$pitch->description?><?php endif?></textarea>
