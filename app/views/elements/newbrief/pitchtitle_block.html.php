<div class="groupc">
    <p>
        <label class="required">Название проекта <?= $this->view()->render(array('element' => 'newbrief/required_star')) ?> <!--a href="#" class="second tooltip" title="Кратко напишите, что вам необходимо создать и для какого бренда. (прим.: обёртка для шоколада “Мишка на севере”) Подробнее о брифе в разделе “Помощь”.">(?)</a--></label>
