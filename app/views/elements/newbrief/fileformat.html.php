...
if($category->id != 7):?>
    <ul class="extensions">
        ...
        <li class="wide graysupplement"><label><input type="checkbox" name="" data-value="Innd" <?php echo extensionsCheckboxChecked('Innd', $defaults, $category, $pitch);?> >.Innd (In Design)</label></li>
