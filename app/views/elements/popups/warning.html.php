...
<div id="popup-final-step-multi" class="popup-final-multi" style="display:none;">
    ...
    <br />
    <p>После завершения оплаты вы не сможете изменить своё мнение. Пожалуйста, убедитесь еще раз в верности вашего решения. Вы уверены, что <?= $pitchesCount + 2 ?> победителем питча становится <a id="winner-user-link-multi" href="#" target="_blank"></a> с решением <a id="winner-num-multi" href="#" target="_blank"></a>?</p>
    <div class="portfolio_gallery" style="width:200px;margin-bottom:5px;">
        <ul class="list_portfolio">
            <li>
