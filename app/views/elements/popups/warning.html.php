<div id="popup-final-step" class="popup-final-step" style="display:none;">
    ...
    <p>Помните, что у вас также есть возможность выбрать <span id="roman">II</span> победителя. Подробнее <a title="Как выбрать второго победителя?" href="https://www.godesigner.ru/answers/view/97">тут</a>.</p>
...
<div id="popup-need-wait" style="display: none;">
    ...
    <p>Пока вы можете принять участие в наших <a href="<?= count($freePitch) > 0 ? '/pitches/details/' . $freePitch->id : 'https://www.godesigner.ru/posts/view/192' ?>">бесплатных проектах</a>. Вы также можете пройти <a href="/questions">тест на профпригодность</a>, что уменьшит срок ожидания на 5 дней!</p>
