        ...
        <?php if ($pitch->category_id != 10):?>
            ...
            <tr id="paymaster-select" class="paymaster-section" style="display: none;">
                <td colspan="4">
                    ...
                    <script type='text/javascript' src='https://paymaster.ru/widget/BasicFP/1?LMI_MERCHANT_ID=d5d2e177-6ed1-4e5f-aac6-dd7ea1c16f60&LMI_PAYMENT_AMOUNT=1&LMI_PAYMENT_DESC=<?php echo urlencode('Оплата питча')?>&LMI_CURRENCY=RUB' async></script>
                </td>
            </tr>
        <?php endif;?>
        </table>
