...
<tr><td colspan="2" style="border-bottom:1px solid;"><h2 style="margin:0">Акт № <?=$pitch->id?> от <?=date('d.m.Y', strtotime($pitch->totalFinishDate));?></h2></td></tr>
...
<td style="border-left:1px solid;border-top:1px solid;border-bottom:1px solid; text-align:center;">
    <?=$money->formatMoney($pitch->total, array('suffix' => '.00р', 'dropspaces' => true))?>
</td>
...
<td height="25" style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid; text-align:center;">
    <b><?=$money->formatMoney($pitch->total, array('suffix' => '.00р', 'dropspaces' => true))?></b>
</td>
</tr>
</table>
