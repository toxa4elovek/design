<table style="" width="550" cellspacing="0" border="0" cellpadding="1">
    <tr ><td width="275"><img src="<?php echo LITHIUM_APP_PATH;?>/webroot/img/logo-01.png" width="180"></td>
        <td>ООО "КРАУД МЕДИА"<br/>г. Санкт-Петербург, ул. Беринга, д. 27<br />ИНН: 7801563047<br />Телефон: 8 800 550 52 07</td></tr>
...
<table style="" width="550" cellspacing="0" cellpadding="1">
    ...
    <tr valign="top">
        ...
        <td style="border-left:1px solid;border-top:1px solid;border-bottom:1px solid; text-align:center;">1</td>
        <td style="border-left:1px solid;border-top:1px solid;border-bottom:1px solid; text-align:center;"><?=$money->formatMoney(($pitch->total - $extracted), ['suffix' => '.00р', 'dropspaces' => true])?></td>
        <td style="border-left:1px solid;border-top:1px solid;border-bottom:1px solid;border-right:1px solid; text-align:center;"><?=$money->formatMoney(($pitch->total - $extracted), ['suffix' => '.00р', 'dropspaces' => true])?></td>
    </tr>
    <tr valign="top">
        ...
        <td style="border-left:1px solid;border-bottom:1px solid; text-align:center;"><?=$money->formatMoney($extracted, ['suffix' => '.00р', 'dropspaces' => true])?></td>
        <td style="border-left:1px solid;border-bottom:1px solid;border-right:1px solid; text-align:center;"><?=$money->formatMoney($extracted, ['suffix' => '.00р', 'dropspaces' => true])?></td>
    </tr>
    <tr height="25">
...
<p style="">Всего наименований 2, на сумму <?=$money->formatMoney($pitch->total, ['suffix' => '.00р', 'dropspaces' => true])?>.</p>
