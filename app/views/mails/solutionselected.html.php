    ...
    <table width="800">
        ...
        <tr><td width="5"></td><td valign="top">
            ...
            <td>
                ...
                <span style="color: #AEAEAE; line-height: 17px; font-size: 11px; font-family: Arial, sans-serif;"><?= mb_strtoupper($pitch['industry'] . ', гонорар: ' . (int) $pitch['price'] . ' Р.-', 'utf-8')?></span><br/>
