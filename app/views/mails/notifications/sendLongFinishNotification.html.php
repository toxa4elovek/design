...
<table>
    ...
    <tr><td width="5"></td><td valign="top">
        ...
        <td>
            ...
            <span style="color: #AEAEAE; line-height: 17px; font-size: 11px; font-family: Arial, sans-serif;"><?=$this->view()->render(['template' => 'pitch-info'], ['pitch' => $project]);?></span><br/>
            <span style="color: #444444; line-height: 17px; font-size: 12px; font-family: Arial, sans-serif;">Завершение проекта затянулось. <a href="https://cp.godesigner.ru/users/loginasadmin?query=redirect&redirect=https://godesigner.ru/users/step<?= $step?>/<?= $project->awarded ?>">Войти как администратор</a><br/></span><br/>
        </td></tr>
    <tr>
