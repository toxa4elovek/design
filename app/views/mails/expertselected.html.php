...
<table width="800">
    ...
    <tr><td width="5"></td><td valign="top">
        ...
        <td>
            ...
            <span style="color: #444444; line-height: 17px; font-size: 12px; font-family: Arial, sans-serif;">Вас выбрали экспертом в этом питче, который закончится через <?=$pitch->startedHuman?>. Когда срок подойдет к концу, в течение 2 дней вам нужно оставить на сайте комментарий к 3 лучшим решениям, и пояснить, почему вы их выбрали в качестве фаворитов.</span><br/>
        </td></tr>
    <tr>
