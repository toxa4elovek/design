...
<body style="margin: 0; padding: 0;">
    ...
    <table width="800">
        <tr><td width="5"></td><td width="30"></td><td>
            ...
            <span style="color: #C7C6C7; line-height: 17px; font-size: 9px; font-family: Arial, sans-serif;">НА НАШ САЙТ ДОБАВЛЕН НОВЫЙ ПИТЧ:</span>
        </td></tr>
        ...
        <tr><td width="5"></td><td valign="top">
            ...
            <td>
                ...
                <span style="color: #C7C6C7; line-height: 17px; font-size: 9px; font-family: Arial, sans-serif;"><?= mb_strtoupper($pitch->industry . ', срок: ' . $pitch->startedHuman . ', гонорар: ' . (int) $pitch->price . ' Р.-', 'utf-8')?></span><br/>
