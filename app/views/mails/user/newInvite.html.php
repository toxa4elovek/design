...
<table>
    <tr><td width="5"></td><td width="30"></td><td>
            ...
            <span style="text-transform: uppercase; color: #C7C6C7; line-height: 17px; font-size: 9px; font-family: Arial, sans-serif;">Поздравляем, заказчик персонально приглашает вас к участию в проекте:</span>
        </td></tr>
