...
<table width="800">
    ...
    <tr><td width="5"></td><td valign="top">
        ...
        <td>
            ...
            <span style="color: #444444; line-height: 17px; font-size: 12px; font-family: Arial, sans-serif;"><?=$text?>. <?php if($schedule):?><?php echo date('j F Y H:i'); ?> (московское время)<?php endif;?></span><br/>
        </td></tr>
    <tr>
