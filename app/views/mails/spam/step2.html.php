...
<table>
    <tr><td width="5"></td><td width="30"></td><td>
        ...
        <span style="color: #AEAEAE; line-height: 17px; font-size: 11px; font-family: Arial, sans-serif;">ДОРАБОТКА МАКЕТОВ.</span>
    </td></tr>
    ...
    <tr><td width="5"></td><td valign="top">
        ...
        <td>
            <a style="color: #ff585d; line-height: 17px; font-size: 20px; font-weight: bold; font-family: Arial, sans-serif;text-decoration: none;" href="https://www.godesigner.ru/users/step2/<?=$solution->id?>"><?=$pitch->title?></a><br/>
