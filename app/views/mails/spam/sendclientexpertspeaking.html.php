...
<body style="margin: 0; padding: 0;">
    ...
    <table width="800">
        <tr>
            ...
            <td>
                <a style="color: #ff5360; line-height: 23px; font-size: 20px; font-weight: bold; font-family: Arial, sans-serif;text-decoration: none;" href="https://www.godesigner.ru/pitches/view/<?=$pitch->id?>"><?=$pitch->title?></a><br/>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="https://www.godesigner.ru/pitches/view/<?=$pitch->id?>#comment-anchor">https://www.godesigner.ru/pitches/view/<?=$pitch->id?></a>
                </span>
            </td>
        </tr>
        <tr>
