                                ...
                                <table cellpadding="0" cellspacing="0" width="100%" align="left" style="border-collapse: collapse;">
                                    <tr>
                                        <td align="center"><span style="color:#7d7c7c;font-size: 14px; font-family: Arial, sans-serif;line-height:2">
                                                ...
                                                <a style="color:#f45151;text-decoration: none;" href="https://godesigner.ru/users/sale?id=<?= $sale ?>"><?= $pitch->title ?></a><br />
                                                ...
                                                а вы сэкономите 2000р.-</span>
                                        </td>
                                    </tr>
                                    <tr><td height="30"></td></tr>
                                    <tr>
                                        <td align="center">
                                            <a href="https://godesigner.ru/users/sale?id=<?= $sale ?>" target="_blank"><img src="http://godesigner.ru/img/mail/go_to_project.png" alt="Войти и заполнить реквизиты" border="0" width="500" height="50" /></a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align="center" style="line-height: 13px; font-size: 9px; font-family: Arial, sans-serif;">
                                            <span style="color: #999999; text-transform: uppercase; line-height: 13px; font-size: 9px; font-family: Arial, sans-serif;">
                                                ...
                                                <a style="color: #6990a0; text-decoration: underline; text-transform: uppercase; line-height: 13px; font-size: 9px; font-family: Arial, sans-serif;" target="_blank" href="https://godesigner.ru/users/unsubscribe<?= $pitch->user->unsubscribeToken() ?>">
