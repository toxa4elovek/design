...
<?php
if($blue) {
    $imgSrc = 'https://godesigner.ru/img/logo_original-03.png';
    $color = '#648fa4';
}else {
    $imgSrc = 'https://godesigner.ru/img/logo_original-01.png';
    $color = '#ff585d';
}
?>
...
<table>
    ...
    <tr><td width="5"></td><td valign="top">
        ...
        <td>
            <a style="color: <?= $color?>; line-height: 17px; font-size: 20px; font-weight: bold; font-family: Arial, sans-serif;text-decoration: none;" href="https://godesigner.ru/users/step4/<?=$solution->id?>"><?=$pitch->title?></a><br/>
