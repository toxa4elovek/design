...
<table>
    ...
    <tr><td width="5"></td><td valign="top">
        ...
        <td>
            <a style="color: #ff585d; line-height: 17px; font-size: 20px; font-weight: bold; font-family: Arial, sans-serif;text-decoration: none;" href="https://godesigner.ru/users/step3/<?=$solution->id?>"><?=$pitch->title?></a><br/>
