...
<table cellpadding="0" cellspacing="0" width="570" align="center" style="border-collapse: collapse;">
    ...
    <tr>
        <td height="35" align="center" style="text-align: center;"><div style="line-height: 0;"><img src="http://godesigner.ru/img/referal-text.png" alt="Партнёрская программа" width="419" height="35" valign="top" /></div></td>
    </tr>
                ...
                <tr>
                    ...
                    <td width="530">
                        <table cellpadding="0" cellspacing="0" width="100%" align="left" style="border-collapse: collapse;">
                            ...
                            <tr><td height="30"></td></tr>
                            <tr><td align="center">
                                <img src="http://godesigner.ru/img/referal-illustration-small.png" alt="">
                            </td></tr>
                            <tr><td height="40"></td></tr>
                            <tr><td align="center">
                                <a href="http://godesigner.ru/users/referal">
                                <img src="http://godesigner.ru/img/referal-button.png" alt="Получить код">
                                </a>
                            </td></tr>
