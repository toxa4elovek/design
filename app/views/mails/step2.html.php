...
<table width="800">
    ...
    <tr><td width="5"></td><td valign="top">
        ...
        <td>
            <a style="color: #ff585d; line-height: 17px; font-size: 20px; font-weight: bold; font-family: Arial, sans-serif;text-decoration: none;" href="http://www.godesigner.ru/users/step2/<?=$solution->id?>"><?=$pitch->title?></a><br/>
