...
<table>
    <tr><td width="5"></td><td width="30"></td><td>
            ...
            <span style="color: #AEAEAE; line-height: 17px; font-size: 11px; font-family: Arial, sans-serif;">ДОБАВЛЕНО НОВОЕ РЕШЕНИЕ.</span>
        </td></tr>
    ...
    <tr><td width="5"></td><td valign="top">
        ...
        <td>
            ...
            <a href="https://godesigner.ru/pitches/viewsolution/<?=$solution->id?>"><img src="https://godesigner.ru/<?=$this->solution->renderImageUrl($solution->images['solution_galleryLargeSize'])?>" alt=""></a>
            <br>
