                    ...
                    <td width="530">
                        <table cellpadding="0" cellspacing="0" width="100%" align="left" style="border-collapse: collapse;">
                            ...
                            <tr><td><span style="color: #666666; line-height: 24px; font-size: 16px; font-family: Arial, sans-serif;">
                                        Ваше решение <a style="text-decoration: none;color: #6990a0;" href="http://www.godesigner.ru/pitches/viewsolution/<?= $solution->id?>">#<?= $solution->num?></a> для проекта <a style="text-decoration: none;color: #6990a0;" href="http://www.godesigner.ru/pitches/view/<?=$pitch->id?>">«<?= $pitch->title?>»</a> хочет выкупить посетитель GoDesigner за 6000 р. в рамках <a style="text-decoration: none;color: #6990a0;" href="http://www.godesigner.ru/logosale">распродажи логотипов</a>.</span></td></tr>
                            <tr><td height="30"></td></tr>
                            <tr><td align="center">
                                    <table style="background-color: #ffffff;">
                                        ...
                                        <tr height="180"><td width="12"></td>
                                            <td width="220">
                                                <a href="http://www.godesigner.ru/pitches/viewsolution/<?= $solution->id?>">
                                                <img width="220" height="180" src="http://www.godesigner.ru/<?=$this->solution->renderImageUrl($solution->images['solution_galleryLargeSize'])?>" alt="">
                                                </a>
                                            </td>
                                            <td width="12"></td>
                                        </tr>
