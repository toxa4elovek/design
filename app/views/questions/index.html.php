        ...
        <div class="middle_inner">
            ...
            <div class="content group narrow">
                <section class="howitworks quiz">
                    ...
                    <p style="margin-bottom: 10px;">Этот тест не претендует на замену госэкзаменов в художественных ВУЗах и не гарантирует диплом по специльности «Дизайнер». Нашей целью стал праздный интерес к уровню воды в реке под названием Графический дизайн. Мы создали 15 вопросов, в каждом из которых всего один верный ответ. На прохождение теста даётся 3 минуты!</p>

                    <p>Если вы <a href="http://www.godesigner.ru/register" target="_blank">зарегистрируетесь на сайте</a>, пройдёте тест на хорошо или отлично с <span style="font-style: italic;">первого раза и поделитесь своим результатам</span> в социальных сетях, вы сможете принимать участие в проектах уже через 5 дней (вместо 10 дней).</p>
