        ...
        <div class="middle_inner">
            ...
            <div class="content group narrow">
                <section class="howitworks quiz">
                    ...
                    <p>Если вы <a href="http://www.godesigner.ru/register" target="_blank">зарегистрируетесь на сайте</a>, пройдёте тест на хорошо или отлично с <span style="font-style: italic;">первого раза и поделитесь своими результатами</span> в социальных сетях, вы сможете принимать участие в проектах уже через 5 дней (вместо 10 дней).</p>
