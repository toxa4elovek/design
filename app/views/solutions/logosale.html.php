    ...
    <div class="middle">
        <div class="middle_inner_gallery" style="padding-top:25px">
            ...
            <p class="sale-str regular">
                ...
                и экономичный способ получить результат на GoDesigner. <a href="https://godesigner.ru/answers/view/99" target="_blank" title="Подробнее">Подробнее..</a>
            </p>
                                                ...
                                                <?php if((($solution['pitch']['private'] != 1) && ($solution['pitch']['category_id'] != 7))):
                                                    ...
                                                    <div class="sharebar">
                                                        <div class="tooltip-block">
                                                            <div class="social-likes" data-counters="no" data-url="https://godesigner.ru/pitches/viewsolution/<?=$solution['id']?>" data-title="<?= $tweetLike ?>">
                                                                <div class="facebook" title="Поделиться ссылкой на Фейсбуке">SHARE</div>
                                                                <div class="twitter">TWITT</div>
                                                                <div class="vkontakte" title="Поделиться ссылкой во Вконтакте" data-image="<?= 'https://godesigner.ru'. $this->solution->renderImageUrl($solution['images']['solution_solutionView'])?>">SHARE</div>
                                                                <div class="pinterest" title="Поделиться картинкой на Пинтересте" data-media="<?= 'https://godesigner.ru'. $this->solution->renderImageUrl($solution['images']['solution_solutionView'])?>">PIN</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                <?php endif;?>
