                            ...
                            <?php if ($post->published == 1):?>
                                <div style="margin-top: 25px;">
                                    <div style="margin-top: -20px;" class="social-likes" data-zeroes="yes" data-counters="yes" data-url="https://godesigner.ru/posts/view/<?=$post->id?>">
                                        ...
                                        <div style="margin: 7px 0 0 7px;" class="pinterest" data-media="https://godesigner.ru<?=$post->imageurl?>" title="Поделиться картинкой на Пинтересте">PIN</div>
                                    </div>
...
<?=$this->html->script(['/js/fotorama/jquery-1.8.0.min.js', '/js/fotorama/jquery.validate.min.js', '/js/fotorama/jquery.countdown.min.js', 'jquery.timeago', '/js/fotorama/fotorama.js', 'social-likes.min.js', 'posts/view'], ['inline' => false])?>
<?=$this->html->style(['/js/fotorama/fotorama.css', '/help', '/blog', '/css/common/buttons.css', '/css/posts/view.css', 'disqus', '/css/social-likes_flat'], ['inline' => false])?>