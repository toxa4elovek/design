...
Router::connect('/golden-fish/1', 'Pages::goldenfish');
Router::connect('/golden-fish/2', 'Pages::goldenfish');
Router::connect('/golden-fish/3', 'Pages::goldenfish');
...
Router::connect('/users/view/{:id}', 'Users::view');
